<template>
    <v-main class="list">
        ...
        <v-card>
            <v-data-table :headers="headers" :items="todos" :search="search" :expanded.sync="expanded" item-key="note"
                show-expand>
        ...
        <v-snackbar v-model="snackbar" :timeout="timeout" :color="getColor(tempPriority)" v-if="tempPriority === 'Penting'" right top>
            <v-icon left>
                mdi-alarm
            </v-icon>
            Notes Priority : {{ tempPriority }}
        </v-snackbar>
        <v-snackbar v-model="snackbar" :timeout="timeout" :color="getColor(tempPriority)" v-if="tempPriority === 'Tidak Penting'">
            <v-icon left>
                mdi-heart
            </v-icon>
            Notes Priority : {{ tempPriority }}
        </v-snackbar>
        <v-snackbar v-model="snackbar" :timeout="timeout" :color="getColor(tempPriority)" v-if="tempPriority === 'Biasa'" left top>
            <v-icon left>
                mdi-pause
            </v-icon>
            Notes Priority : {{ tempPriority }}
